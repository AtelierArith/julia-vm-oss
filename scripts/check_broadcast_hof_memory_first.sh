...
targets=(
    ...
    "subset_julia_vm_vm/src/vm/exec/hof.rs"
    "subset_julia_vm_vm/src/vm/hof_exec/dispatch.rs"
    "subset_julia_vm_vm/src/vm/hof_exec/value_mode.rs"
    "subset_julia_vm_vm/src/vm/util.rs"
)
...
if rg -n 'TypedArrayValue::new|new_typed_array_ref' subset_julia_vm_vm/src/vm/hof_exec/value_mode.rs; then
