...
/// # Safety
///
/// `latex_ptr` must be null or point to a valid null-terminated C string that
/// stays alive for the duration of the call.
#[cfg(not(target_arch = "wasm32"))]
#[no_mangle]
pub unsafe extern "C" fn unicode_lookup(latex_ptr: *const c_char) -> *mut c_char {
...
/// # Safety
///
/// `prefix_ptr` must be null or point to a valid null-terminated C string that
/// stays alive for the duration of the call.
#[cfg(not(target_arch = "wasm32"))]
#[no_mangle]
pub unsafe extern "C" fn unicode_completions(prefix_ptr: *const c_char) -> *mut c_char {
    panic_boundary::catch_unwind_ffi(
        |_| std::ptr::null_mut(),
        || {
...
/// # Safety
///
/// `input_ptr` must be null or point to a valid null-terminated C string that
/// stays alive for the duration of the call.
#[cfg(not(target_arch = "wasm32"))]
#[no_mangle]
pub unsafe extern "C" fn unicode_expand(input_ptr: *const c_char) -> *mut c_char {
    panic_boundary::catch_unwind_ffi(
        |_| std::ptr::null_mut(),
        || {
...
/// # Safety
///
/// `unicode_ptr` must be null or point to a valid null-terminated C string
/// that stays alive for the duration of the call.
#[cfg(not(target_arch = "wasm32"))]
#[no_mangle]
pub unsafe extern "C" fn unicode_reverse_lookup(unicode_ptr: *const c_char) -> *mut c_char {
    panic_boundary::catch_unwind_ffi(
        |_| std::ptr::null_mut(),
        || {
