...
pub use error::{
    ...
    execution_result_artifact_data, execution_result_artifact_mime, execution_result_complex_imag,
...
pub use repl_ffi::{
    free_repl_result, is_expression_complete, repl_result_artifact_data, repl_result_artifact_mime,
    repl_session_eval, repl_session_free, repl_session_new, repl_session_reset, split_expressions,
    CREPLResult,
};
