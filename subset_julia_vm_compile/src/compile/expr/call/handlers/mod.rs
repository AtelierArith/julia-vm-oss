...
use crate::ir::core::{Expr, InternedStr};
...
pub(super) struct CallCtx<'a> {
    ...
    pub(super) kwargs: &'a [(InternedStr, Expr)],
...
pub(super) fn special_case_handler(name: &str) -> Option<CallHandler> {
    Some(match name {
        ...
        "Regex" => strings::compile_regex_new,
        "match" => strings::compile_regex_match,
        "eachmatch" => strings::compile_regex_eachmatch,
        "inv" => math::compile_inv,
        "\\" => math::compile_left_division,
        // _bigint_idiv(a, b) — BigInt truncating division intrinsic.
        // Used by div(a::BigInt, b::BigInt) in intfuncs.jl to avoid the
        // ÷→div lowering recursion (Issue #8900).
        "_bigint_idiv" => math::compile_bigint_idiv,
        ...
        "_deepcopy" => misc::compile_deepcopy,
