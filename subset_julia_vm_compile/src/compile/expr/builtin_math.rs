    ...
    pub(in super::super) fn compile_builtin_math(
        ...
        match name {
            "rand" => {
                ...
                } else if let Some((sty, dims)) =
                    super::builtin::leading_scalar_rand_array_type(args)
                {
            ...
            "sqrt" => {
                ...
                if matches!(arg_ty, JuliaType::BigFloat) {
                    ...
                    return Ok(Some(ValueType::BigFloat));
                }
                ...
                if matches!(value_ty, ValueType::Any | ValueType::Struct(_)) || !exact_primitive {
