...
pub fn type_param_base_name(name: &str) -> &str {
    name.split_once("<:")
...
pub fn usable_upper_bound(bound: Option<&str>) -> Option<&str> {
...
pub fn type_param_upper_bound(type_param: &TypeParam) -> Option<&str> {
    type_param
        .get_upper_bound()
        .map(String::as_str)
...
pub fn type_param_upper_bound_core(type_param: &TypeParam) -> CoreType {
    type_param_upper_bound(type_param).map_or(CoreType::Any, CoreType::from_julia_name)
}

/// Find a `where` parameter by base name.
pub fn find_type_param<'a>(type_params: &'a [TypeParam], var_name: &str) -> Option<&'a TypeParam> {
    type_params
        .iter()
...
pub fn core_type_var_upper_bound(var: &CoreTypeVar) -> CoreType {
...
#[derive(Debug)]
pub struct TupleVarargExpansion {
...
/// stays rejected).
pub fn expand_tuple_vararg_pattern_for_len(
...
pub fn core_expand_tuple_vararg_pattern_for_len(
...
pub fn tuple_vararg_pattern_dominates(
...
pub fn tuple_vararg_patterns_conflict(
...
#[derive(Debug)]
pub struct TupleDiagonalPattern {
...
/// method signature.
pub fn repeated_tuple_typevar_pattern(
...
pub fn actual_tuple_satisfies_diagonal_pattern(
...
pub fn tuple_diagonal_candidate_dominates_other(
...
pub fn core_repeated_tuple_typevar_pattern(
...
/// (Issue #6495 stage 5).
pub fn core_tuple_diagonal_candidate_dominates_other(
...
pub fn union_actual_candidate_dominates(
    candidate: &[JuliaType],
    other: &[JuliaType],
    arg_types: &[JuliaType],
    hierarchy: &StructHierarchy,
...
pub fn core_union_actual_candidate_dominates(
    candidate: &[CoreType],
    other: &[CoreType],
    arg_cores: &[CoreType],
    hierarchy: &StructHierarchy,
...
/// value slot (`::T`).
#[derive(Debug)]
pub struct TypeValueDiagonalPattern {
    pub upper_bound: CoreType,
    pub type_slot: usize,
...
pub fn type_value_diagonal_pattern(
    param_types: &[JuliaType],
    type_params: &[TypeParam],
...
/// equivalent.
pub fn actual_type_value_diagonal_binding<'a>(
...
/// corresponding slots.
pub fn type_value_diagonal_candidate_dominates_other(
    other_param_types: &[JuliaType],
    pattern: &TypeValueDiagonalPattern,
    binding: &JuliaType,
    hierarchy: &StructHierarchy,
...
pub fn core_type_value_diagonal_pattern(
    param_types: &[CoreType],
    type_vars: &[CoreTypeVar],
) -> Option<TypeValueDiagonalPattern> {
    if param_types.len() != 2 {
...
pub fn core_type_value_diagonal_candidate_dominates_other(
    other_param_types: &[CoreType],
    pattern: &TypeValueDiagonalPattern,
    binding: &CoreType,
    hierarchy: &StructHierarchy,
...
#[derive(Debug)]
pub struct TypeVectorDiagonalPattern {
    pub upper_bound: CoreType,
    pub type_slot: usize,
...
pub fn type_vector_diagonal_pattern(
    param_types: &[JuliaType],
    type_params: &[TypeParam],
...
pub fn actual_type_vector_diagonal_binding<'a>(
    arg_types: &'a [JuliaType],
...
/// and vector slots.
pub fn type_vector_diagonal_candidate_dominates_other(
    other_param_types: &[JuliaType],
    pattern: &TypeVectorDiagonalPattern,
    binding: &JuliaType,
    hierarchy: &StructHierarchy,
...
pub fn abstract_vector_param_type(ty: &JuliaType) -> Option<CoreType> {
...
pub fn core_type_vector_diagonal_pattern(
    param_types: &[CoreType],
    type_vars: &[CoreTypeVar],
) -> Option<TypeVectorDiagonalPattern> {
    if param_types.len() != 2 {
...
pub fn core_type_vector_diagonal_candidate_dominates_other(
    other_param_types: &[CoreType],
    pattern: &TypeVectorDiagonalPattern,
    binding: &CoreType,
    hierarchy: &StructHierarchy,
...
/// stage 5).
pub fn core_abstract_vector_param_type(ty: &CoreType) -> Option<CoreType> {
...
#[derive(Debug)]
pub struct TypeMatrixDiagonalPattern {
    pub upper_bound: CoreType,
    pub type_slot: usize,
...
pub fn type_matrix_diagonal_pattern(
    param_types: &[JuliaType],
    type_params: &[TypeParam],
...
/// to, if both agree and respect the bound.
pub fn actual_type_matrix_diagonal_binding<'a>(
    arg_types: &'a [JuliaType],
...
/// Whether the bound diagonal candidate strictly beats another method's type
/// and matrix slots.
pub fn type_matrix_diagonal_candidate_dominates_other(
    other_param_types: &[JuliaType],
    pattern: &TypeMatrixDiagonalPattern,
    binding: &JuliaType,
    hierarchy: &StructHierarchy,
...
pub fn abstract_matrix_param_type(ty: &JuliaType) -> Option<CoreType> {
...
/// stage 5).
pub fn core_type_matrix_diagonal_pattern(
    param_types: &[CoreType],
    type_vars: &[CoreTypeVar],
) -> Option<TypeMatrixDiagonalPattern> {
    if param_types.len() != 2 {
...
pub fn core_type_matrix_diagonal_candidate_dominates_other(
    other_param_types: &[CoreType],
    pattern: &TypeMatrixDiagonalPattern,
    binding: &CoreType,
    hierarchy: &StructHierarchy,
...
/// stage 5).
pub fn core_abstract_matrix_param_type(ty: &CoreType) -> Option<CoreType> {
...
fn abstract_container_element_type(
    ...
    let core = match ty {
        JuliaType::Struct(name) => CoreType::from_julia_name(name),
        _ => CoreType::from(ty),
    };
    core_abstract_container_element_type(&core, bare, expected_name, expected_rank)
}
...
#[derive(Debug)]
pub struct VectorDiagonalPattern<'a> {
    pub var_name: &'a str,
    pub upper_bound: CoreType,
    pub slots: Vec<usize>,
}
...
/// (Issue #6229).
pub fn repeated_vector_typevar_pattern<'a>(
    param_types: &[JuliaType],
...
/// element type.
pub fn actual_vector_slots_share_element_type(arg_types: &[JuliaType], slots: &[usize]) -> bool {
...
pub fn independent_vector_bounds_are_no_tighter(
    param_types: &[JuliaType],
...
pub fn core_repeated_vector_typevar_pattern<'a>(
    param_types: &[CoreType],
    type_vars: &'a [CoreTypeVar],
) -> Option<VectorDiagonalPattern<'a>> {
    let mut counts: HashMap<&str, Vec<usize>> = HashMap::new();
...
/// (Issue #6495 stage 5).
pub fn core_independent_vector_bounds_are_no_tighter(
    param_types: &[CoreType],
    pattern: &VectorDiagonalPattern<'_>,
    hierarchy: &StructHierarchy,
) -> bool {
...
mod tests {
    ...
    fn abstract_container_element_extraction_is_structured() {
        ...
        let nominal_t = CoreType::Named("T".to_string());
        assert_eq!(abstract_vector_param_type(&rank1), Some(nominal_t.clone()));
        assert_eq!(abstract_vector_param_type(&rank2), None);
        assert_eq!(abstract_matrix_param_type(&rank2), Some(nominal_t.clone()));
        assert_eq!(abstract_vector_param_type(&rank_var), None);
        assert_eq!(abstract_matrix_param_type(&rank_var), None);
