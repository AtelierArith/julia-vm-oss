...
use super::value::{
    BigFloatRoundingMode, RustBigFloat, RustBigInt, StructInstance, Value, BIGFLOAT_PRECISION,
};
use super::Vm;
        ...
        match intrinsic {
            ...
            Intrinsic::SdivInt => {
                ...
                match (&a_val, &b_val) {
                    (Value::I128(a), Value::I128(b)) => {
                        ...
                        self.stack.push(Value::I128(a / b));
                    }
            ...
            Intrinsic::RemBigFloat => {
                ...
                let result = if b.is_zero() {
                    RustBigFloat::from_f64(f64::NAN, BIGFLOAT_PRECISION)
                } else {
                    a.rem(&b)
                };
