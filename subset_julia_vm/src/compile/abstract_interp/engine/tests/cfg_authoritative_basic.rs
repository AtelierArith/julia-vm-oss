...
fn test_cfg_authoritative_all_return_if_call_payload_5602() {
    ...
    let call_id = |arg: Expr| Expr::Call {
        function: "cfg_call_id".to_string(),
        args: vec![arg],
        kwargs: vec![],
            ...
            stmts: vec![Stmt::If {
                ...
                then_branch: Block {
                    stmts: vec![Stmt::Return {
                        value: Some(call_id(Expr::Var("x".to_string(), dummy_span()))),
                        span: dummy_span(),
                    }],
                    span: dummy_span(),
                },
                else_branch: Some(Block {
                    stmts: vec![
                        Stmt::Assign {
                            var: "y".to_string(),
                            value: call_id(Expr::Var("x".to_string(), dummy_span())),
                            span: dummy_span(),
                        },
                        Stmt::Return {
...
fn test_cfg_authoritative_all_return_if_binary_payload_5602() {
    ...
    let var_x = || Expr::Var("x".to_string(), dummy_span());
            ...
            stmts: vec![Stmt::If {
                ...
                then_branch: Block {
                    stmts: vec![Stmt::Return {
                        value: Some(Expr::UnaryOp {
                            op: UnaryOp::Neg,
                            operand: Box::new(Expr::Var("x".to_string(), dummy_span())),
                            span: dummy_span(),
                        }),
                        span: dummy_span(),
                    }],
                ...
                else_branch: Some(Block {
                    stmts: vec![Stmt::Return {
                        value: Some(Expr::UnaryOp {
                            op: UnaryOp::Not,
                            operand: Box::new(Expr::Var("flag".to_string(), dummy_span())),
                            span: dummy_span(),
                        }),
                        span: dummy_span(),
                    }],
...
fn test_cfg_authoritative_all_return_if_ternary_payload_5602() {
    ...
    let var_x = || Expr::Var("x".to_string(), dummy_span());
    let choose = || Expr::Var("choose".to_string(), dummy_span());
    let one = || Expr::Literal(Literal::Int(1), dummy_span());
    let func = Function {
...
fn test_cfg_authoritative_all_return_if_index_payload_5602() {
    ...
    let first_element = |name: &str| Expr::Index {
        array: Box::new(Expr::Var(name.to_string(), dummy_span())),
...
fn test_cfg_authoritative_all_return_if_slice_range_index_payload_5602() {
    ...
    let matrix_slice_all = Expr::Index {
        array: Box::new(Expr::Var("m".to_string(), dummy_span())),
    ...
    let func = Function {
        ...
        body: Block {
            stmts: vec![Stmt::If {
                ...
                then_branch: Block {
                    stmts: vec![Stmt::Return {
                        value: Some(Expr::Var("val".to_string(), dummy_span())),
                        span: dummy_span(),
                    }],
                    span: dummy_span(),
                },
...
fn test_cfg_authoritative_all_return_if_typeof_edge_narrowing_5602() {
    ...
    let condition = Expr::BinaryOp {
        ...
        left: Box::new(Expr::Call {
            ...
            args: vec![Expr::Var("val".to_string(), dummy_span())],
            kwargs: vec![],
            splat_mask: vec![false],
            kwargs_splat_mask: vec![],
            span: dummy_span(),
