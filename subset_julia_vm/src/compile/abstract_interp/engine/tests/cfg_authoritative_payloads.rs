...
fn test_cfg_authoritative_all_return_if_kwarg_call_payload_5602() {
    let callee = Function {
        ...
        body: Block {
            stmts: vec![Stmt::Return {
                value: Some(Expr::Var("value".to_string(), dummy_span())),
                span: dummy_span(),
            }],
            span: dummy_span(),
        },
    ...
    let call_with_value = |value: Expr| Expr::Call {
        function: "cfg_kwarg_return".to_string(),
        args: vec![],
        kwargs: vec![("value".to_string(), value)],
        splat_mask: vec![],
    ...
    let func = Function {
        ...
        body: Block {
            stmts: vec![Stmt::If {
                condition: Expr::Var("flag".to_string(), dummy_span()),
                then_branch: Block {
                    stmts: vec![Stmt::Return {
                        value: Some(call_with_value(Expr::Var("x".to_string(), dummy_span()))),
                        span: dummy_span(),
                    }],
                    span: dummy_span(),
                },
                else_branch: Some(Block {
                    stmts: vec![Stmt::Return {
                        value: Some(call_with_value(Expr::Var("y".to_string(), dummy_span()))),
                        span: dummy_span(),
                    }],
                    span: dummy_span(),
                }),
...
fn test_cfg_authoritative_all_return_if_positional_splat_call_payload_5602() {
    ...
    let direct_call = Expr::Call {
        function: "cfg_splat_first".to_string(),
        args: vec![
...
fn test_cfg_authoritative_all_return_if_keyword_splat_call_payload_5602() {
    ...
    let kw_splat_call = Expr::Call {
        function: "cfg_kw_splat_return".to_string(),
        args: vec![],
        kwargs: vec![(
            String::new(),
    ...
    let func = Function {
        ...
        body: Block {
            stmts: vec![Stmt::If {
                ...
                then_branch: Block {
                    stmts: vec![Stmt::Return {
                        value: Some(array_of(Expr::Var("x".to_string(), dummy_span()))),
                        span: dummy_span(),
                    }],
                    span: dummy_span(),
                },
...
fn test_cfg_authoritative_all_return_if_tuple_literal_payload_5602() {
    ...
    let tuple_payload = |first: Expr| Expr::TupleLiteral {
        elements: vec![first, Expr::Var("y".to_string(), dummy_span())],
        span: dummy_span(),
    };
    let func = Function {
        ...
        body: Block {
            stmts: vec![Stmt::If {
                ...
                then_branch: Block {
                    stmts: vec![Stmt::Return {
                        value: Some(tuple_payload(Expr::Var("x".to_string(), dummy_span()))),
                        span: dummy_span(),
                    }],
                    span: dummy_span(),
                },
...
fn test_cfg_authoritative_all_return_if_namedtuple_literal_payload_5602() {
    ...
    let func = Function {
        ...
        body: Block {
            stmts: vec![Stmt::If {
                ...
                then_branch: Block {
                    stmts: vec![Stmt::Return {
                        value: Some(namedtuple_payload(Expr::Var("x".to_string(), dummy_span()))),
                        span: dummy_span(),
                    }],
                    span: dummy_span(),
                },
    ...
    assert_eq!(
        crate::compile::bridge::lattice_to_julia_type(&result),
        JuliaType::Struct("@NamedTuple{value::Int64}".to_string())
    );
    assert_eq!(
...
fn test_cfg_authoritative_all_return_if_pair_dict_payload_5602() {
    ...
    let pair_payload = |first: Expr| Expr::Pair {
        key: Box::new(first),
        value: Box::new(Expr::Var("y".to_string(), dummy_span())),
        span: dummy_span(),
    };
    ...
    let func = Function {
        ...
        body: Block {
            stmts: vec![Stmt::If {
                ...
                then_branch: Block {
                    stmts: vec![Stmt::Return {
                        value: Some(pair_payload(Expr::Var("x".to_string(), dummy_span()))),
                        span: dummy_span(),
                    }],
                    span: dummy_span(),
                },
    ...
    assert_eq!(
        crate::compile::bridge::lattice_to_julia_type(&dict_ty),
        JuliaType::Struct("Dict{Int64,Float64}".to_string())
    );
    assert_eq!(
        crate::compile::bridge::lattice_to_parametric_julia_type(&dict_ty),
...
fn test_cfg_authoritative_all_return_if_letblock_payload_5602() {
    ...
    let let_payload = |value: Expr| Expr::LetBlock {
        bindings: vec![("y".to_string(), value)],
        body: Block {
            stmts: vec![Stmt::Expr {
                expr: Expr::Var("y".to_string(), dummy_span()),
                span: dummy_span(),
            }],
            span: dummy_span(),
        },
