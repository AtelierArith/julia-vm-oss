...
# Bare operators are intentionally used here to exercise the HOF
# operator-as-argument lowering path.
...
@testset "mergewith! and mergewith" begin
    ...
    d8 = Dict("a" => 1)
    result3 = mergewith!(+, d8, Dict{String,Int64}())
